...
function check_web($data){
	if ($data==1)
	{
		return "<span class='label label-success'>apache</span>";	
	}elseif ($data==2){
		return "<span class='label label-success'>nginx</span>";
	}elseif ($data==3)
	{
		return "<span class='label label-success'>tomcat</span>";
	}else 
	{
		return "---";
	}
...
function check_web_connections($data,$alarm){
    if($data >= $alarm){
        return "<span class='label label-warning'>".$data."</span>";
    }
    else{
