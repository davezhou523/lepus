...
<div class="well">
   ...
   <table class="table table-hover table-bordered  ">
    ...
    <tr>
        ...
        <th><?php echo $this->lang->line('rsa'); ?></th>
...
<input type="hidden" name="ids[]" value="<?php echo $n ?>" /> 
    <tr style="font-size:12px;">
        ...
        <td><input type="text" name="port_<?php echo $n ?>" class="input-small" placeholder="<?php echo $this->lang->line('port'); ?>" value="22"></td>
		<td><input type="text" name="user_<?php echo $n ?>" class="input-small" placeholder="<?php echo $this->lang->line('user'); ?>" value="root"></td>
		<td><textarea cols="200" rows="2" id="" name="rsa_<?php echo $n ?>" placeholder="<?php echo $this->lang->line('rsa'); ?>" value="" style="margin-left: 0px; margin-right: 0px; width: 410px;"></textarea></td>
