...
<html lang="en">
  <head>
    ...
    <link href="lib/notification/css/lobibox.css" rel="stylesheet" type="text/css">
<!--    <link href="lib/ztree/zTreeStyle.css" rel="stylesheet" type="text/css">-->
    <link rel="stylesheet" tyep="text/css" href="lib/ztree/metroStyle/metroStyle.css">
    <link href="lib/flexigrid/flexigrid.css" rel="stylesheet" type="text/css">
    <link href="lib/contextmenu/contextmenu.css" rel="stylesheet" type="text/css">
	...
	<script src="lib/flexigrid/flexigrid.js" type="text/javascript"></script>
	<script src="lib/notification/js/lobibox.js" type="text/javascript"></script>
	<script src="lib/jquery.validate.js" type="text/javascript"></script>
	<script src="lib/additional-methods.js" type="text/javascript"></script>
	<script src="lib/messages_zh.js" type="text/javascript"></script>
	<script src="lib/ztree/jquery.ztree.all.js" type="text/javascript"></script>
  ...
  <!--<![endif]-->
    ...
    <?php $menus = $this->user_model->get_user_menus(); //print_r($menus);exit;?>
...
<!--                        <hr>-->
<!---->
<!--                        <p class="pull-right">Power by <a href="http://www.foocaa.com" target="_blank">Foocaa</a></p>-->
<!---->
<!--                        <p>&copy; 2016 <a href="http://www.foocaa.com" target="_blank">Foocaa</a>(万科物业监控系统)</p>-->
<!--                    </footer>-->
