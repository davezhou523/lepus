...
<div class="control-group">
    <label class="control-label" for=""><?php echo $this->lang->line('user'); ?></label>
    <div class="controls">
      <input type="text" id="" name="user" value="<?php echo $record['user']; ?>">
      <span class="help-inline"></span>
    </div>
   </div>
    <div class="control-group">
...
<!--  <div class="control-group">
    <label class="control-label" for=""><?php echo $this->lang->line('rsa'); ?></label>
    <div class="controls">
      <textarea cols="200" rows="5" id="" name="rsa" value="" style="margin-left: 0px; margin-right: 0px; width: 410px;"><?php echo $record['rsa']; ?></textarea>
      <span class="help-inline"></span>
    </div>
   </div>-->
   ...
   <div class="control-group">
    ...
    <div class="controls">
        ...
        &nbsp;&nbsp;<?php echo $this->lang->line('threshold_warning'); ?>&nbsp;<input type="text" id="threshold_warning_os_network" class="input-small" placeholder="" name="threshold_warning_os_network" value="<?php echo $record['threshold_warning_os_network']; ?>" >MB/s
        &nbsp;&nbsp;<?php echo $this->lang->line('threshold_critical'); ?>&nbsp;<input type="text" id="threshold_critical_os_network" class="input-small" placeholder="" name="threshold_critical_os_network" value="<?php echo $record['threshold_critical_os_network']; ?>" >MB/s
    </div>
   </div>
    <div class="control-group">
