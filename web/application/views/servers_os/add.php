...
<div class="well">
   ...
   <div class="control-group">
    ...
    <div class="controls">
      <input type="text" id="" name="port" value="22">
      <span class="help-inline"></span>
    </div>
   </div>
<div class="control-group">
    ...
    <div class="controls">
      <input type="text" id="" name="user" value="root">
      <span class="help-inline"></span>
    </div>
   </div>
  <div class="control-group">
  ...
  <div class="control-group">
    ...
    <div class="controls">
      <textarea cols="200" rows="5" id="" name="rsa" value="" style="margin-left: 0px; margin-right: 0px; width: 410px;"></textarea>
      <span class="help-inline"></span>
    </div>
   </div>
   <div class="control-group">
   ...
   <div class="control-group">
    ...
    <div class="controls">
        ...
        &nbsp;&nbsp;<?php echo $this->lang->line('threshold_warning'); ?><input type="text" id="threshold_warning_os_network" class="input-small" placeholder="" name="threshold_warning_os_network" value="2" >MB/s
        &nbsp;&nbsp;<?php echo $this->lang->line('threshold_critical'); ?><input type="text" id="threshold_critical_os_network" class="input-small" placeholder="" name="threshold_critical_os_network" value="10" >MB/s
    </div>
   </div>
    <div class="control-group">
