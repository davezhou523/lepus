			...
			if (p.searchitems) {
				...
				$(g.sDiv).append("<div class='sDiv2'>" + p.findtext +
						...
						" <select name='qtype'>" + sopt + "</select>" +
								"<input style='border-top-width: 0px;padding-bottom: 10px; padding-left: 10px;border-right-width: 0px;' type='button' name='qsubmitbtn' value='" + p.btnsubmit + "' />" +
										"<input style='border-top-width: 0px;padding-bottom: 10px;padding-left: 10px;border-right-width: 0px;border-left-width: 0px;margin-left: 11‒;margin-left: 9px;' type='button' name='qclearbtn' value='" + p.btnclear + "' /></div>");
