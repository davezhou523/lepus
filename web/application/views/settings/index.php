...
<div class="control-group success">
   ...
   <div class="control-group success">
    <label class="control-label" for="">*<?php echo $this->lang->line('monitor_web'); ?></label>
    <div class="controls">
        <select name="monitor_web" id="monitor_web" class="input-small">
         <option value="1" <?php echo set_selected(1,$settings['monitor_web']) ?> ><?php echo $this->lang->line('on'); ?></option>
         <option value="0" <?php echo set_selected(0,$settings['monitor_web']) ?> ><?php echo $this->lang->line('off'); ?></option>
        </select>
        <span class="help-inline"></span>
    </div>
   </div>
...
<hr>
	...
	<div class="control-group info " id="smstype_div" style="display: block;">
	<?php if($settings['smstype'] !='' and $settings['smstype']=='api'){?>
	    <label class="control-label" for="">*短信接口URL</label>
	    <div class="controls">
	      <input type="text" id="sms_api_url"  name="sms_api_url" value="<?php echo $settings['sms_api_url'] ?>" class="input-large" style="width:578px">
	    </div>
	
    <?php }elseif ($settings['smstype'] !='' and $settings['smstype']=='fetion') { ?>
    		<label class="control-label">*<?php echo $this->lang->line("fetion_user"); ?></label><div class="controls"><input type="text" id="sms_fetion_user"  name="sms_fetion_user" value="<?php echo $settings['sms_fetion_user'] ?>" class="input-large"></div>
		    <label class="control-label">*<?php echo $this->lang->line("fetion_pass"); ?></label><div class="controls"><input type="text" id="sms_fetion_pass"  name="sms_fetion_pass" value="<?php echo $settings['sms_fetion_pass'] ?>" class="input-large"></div>
...
$('#smstype').change(function(){
	...
	{		
		$('#smstype_div').empty();
		var content='<label class="control-label">*短信接口URL</label><div class="controls"><input type="text" id="sms_api_url"  name="sms_api_url" value="<?php echo $settings['sms_api_url'] ?>" class="input-large" style="width:578px"></div>';
		$('#smstype_div').append(content);
	}else if($(this).val()=='fetion'){		
		$('#smstype_div').empty();
		var fetion_user='<label class="control-label">*<?php echo $this->lang->line("fetion_user"); ?></label><div class="controls"><input type="text" id="sms_fetion_user"  name="sms_fetion_user" value="<?php echo $settings['sms_fetion_user'] ?>" class="input-large"></div>';
		var sms_fetion_pass='<label class="control-label">*<?php echo $this->lang->line("fetion_pass"); ?></label><div class="controls"><input type="text" id="sms_fetion_pass"  name="sms_fetion_pass" value="<?php echo $settings['sms_fetion_pass'] ?>" class="input-large"></div>';
	     
		$('#smstype_div').append(fetion_user+sms_fetion_pass);
